...
STRINGS: Final[dict[str, dict[str, str]]] = {
    "tr": {
        ...
        "note_rank_agreement": "{passes} okuma, %{agreement} uyum",
        "note_rank_unranked": "sıralayan olmadı, önem sırası kullanıldı",
        "col_source": "Kaynak",
        "col_weight": "Ağırlık",
        "col_last": "Son durum",
        "col_articles": "Haber",
    ...
    "en": {
        ...
        "note_rank_agreement": "{passes} readings, {agreement}% agreement",
        "note_rank_unranked": "no ranker answered, ordered by importance",
        "col_source": "Source",
        "col_weight": "Weight",
